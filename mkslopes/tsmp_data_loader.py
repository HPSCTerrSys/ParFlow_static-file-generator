...
def load_dem():
    """
    Load the Digital Elevation Model (DEM) EUR-11 data.
    
    Returns
    -------
    numpy.ndarray
        A 2D array of elevation values with shape (432, 444).
    ...
    """
    data_path = _DATA_DIR / "DEM_tsmp.npy"
...
def load_watershed_mask():
    ...
    """
    data_path = _DATA_DIR / "watershed_mask_tsmp.npy"
    if not data_path.exists():
...
def load_river_mask():
    ...
    """
    data_path = _DATA_DIR / "river_mask_tsmp.npy"
    if not data_path.exists():
